...
namespace StudentFinalProject.Controllers
{
    ...
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,address,course_id,batch_id,telno")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,address,course_id,batch_id,telno")] registration registration)
        {
            if (ModelState.IsValid)
            {
